...
(function (root, factory) {
	...
	/*
	Shader by Sebastian Markbåge, borrowed with permission and slightly tweaked
	http://calyptus.eu/
	*/

	Seriously.plugin('pagecurl', {
		commonShader: true,
		shader: function (inputs, shaderSource) {
			shaderSource.fragment = [
				...
				'	if (yc > 0.0) return texture2D(source, p);',

				'	vec4 color = texture2D(source, vec2(point.x, point.y));',
				...
				//'	//gl_FragColor = antiAlias(gl_FragColor, texture2D(source, p), radius - yc);',
